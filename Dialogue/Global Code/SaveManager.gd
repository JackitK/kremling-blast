...
var last_saved_lv:LastSavedLevelData
...
func _ready():
	...
	last_saved_lv = LastSavedLevelData.load_or_create()
	load_settings_data()
	load_levels_data()
...
func on_levels_save(data: Dictionary) -> void:
	var data_file = FileAccess.open_encrypted_with_pass(LEVELS_SAVE_PATH, FileAccess.WRITE, "KremHunt2025")
...
func load_levels_data() -> void:
	...
	var save_settings_data_file = FileAccess.open_encrypted_with_pass(LEVELS_SAVE_PATH, FileAccess.READ, "KremHunt2025")
	var loaded_data : Dictionary = {}
